...
| `DD_APM_SERVICE_NAME` | *Optional.* If `DD_APM_TRACE_SEARCH` is enabled, this value must be set to the name of your service in Datadog APM. Full string, eg `dd-trace|express.request:`|
